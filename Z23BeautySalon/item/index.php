    ...
    <div id="container">
        ...
        <div class="items-container">
            <?php
                ...
                $sql = "SELECT id , image_url ,title, type, price, quantity FROM item WHERE category='HAIR'";
        ...
        <div class="items-container">
            <?php
                // Fetch items from the database
                $sql = "SELECT id , image_url ,title, type, price, quantity FROM item WHERE category='FACIAL'";
                $result = $conn->query($sql);
